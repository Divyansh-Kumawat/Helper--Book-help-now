      ...
      <div className="userreg-card">
        <div className="userreg-card-inner">
          <div className="userreg-header">
            ...
            <h2 className="userreg-heading">User Sign In</h2>
            <p className="userreg-subheading">Welcome back! Please login to your account.</p>
          </div>
          ...
          <p className="userreg-login-link">
            New to Helper?{' '}
            <Link to="/register/user" className="userreg-login-link-highlight">
              Create an account
            </Link>
          </p>
        </div>
